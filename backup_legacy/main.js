...
const translations = {
  en: {
    ...
    article_title_1: "Why is Lunch Choice So Hard?",
    article_desc_1: "The \"Lunch Menu Paradox\" is a common dilemma in modern life. With too many options available, we often suffer from decision fatigue. Our random recommender helps you bypass this indecision, saving your mental energy for more important tasks. A balanced lunch is crucial for maintaining energy levels throughout the afternoon.",
    article_title_2: "Tips for a Healthy Lunch",
    article_desc_2: "When selecting your menu, try to include a good balance of protein, healthy fats, and complex carbohydrates. Korean cuisine, such as Bibimbap, offers an excellent mix of vegetables and grains. Staying hydrated and avoiding overly heavy meals can prevent the post-lunch slump.",
    rps_game_link: "Rock Paper Scissors Game",
    contact_link: "Affiliate Inquiry",
  ...
  ko: {
    ...
    article_title_1: "점심 메뉴 고르기가 왜 힘들까요?",
    article_desc_1: "현대인들에게 '점심 메뉴 결정 장애'는 흔한 일입니다. 너무 많은 선택지는 오히려 결정을 어렵게 만들고 정신적 피로를 유발합니다. 랜덤 추천기는 이러한 고민을 덜어주어 여러분의 소중한 에너지를 아껴줍니다. 균형 잡힌 점심 식사는 오후의 활력을 유지하는 데 필수적입니다.",
    article_title_2: "건강한 점심을 위한 팁",
    article_desc_2: "메뉴를 선택할 때는 단백질, 건강한 지방, 복합 탄수화물의 균형을 고려해보세요. 비빔밥과 같은 한식은 채소와 곡물을 골고루 섭취할 수 있는 훌륭한 선택입니다. 또한, 충분한 수분 섭취와 과식을 피하는 것은 식곤증을 예방하는 데 도움이 됩니다.",
    rps_game_link: "가위바위보 게임",
    contact_link: "제휴 문의",
    contact_title: "제휴 문의",
    label_name: "이름",
    label_email: "이메일",
